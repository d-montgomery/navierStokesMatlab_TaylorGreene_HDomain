function [XU,YU,XV,YV,xp,yp,N] = NSGridHnoGhst(Nx,Ny,Wleft,Wmid,Wright,Hlow,Hmid,Hup,GRID,PLOT)
...
elseif GRID == 1
    ...
    elseif GRID == 4
        ...
        % Injury Channel - x
        xI = (Wleft - (Wleft+Wmid))/2*cos((0:NxMid)*pi/NxMid) + (Wleft + Wleft+Wmid)/2;
